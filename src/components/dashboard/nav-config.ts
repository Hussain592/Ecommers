...
export const vendorNav: NavItem[] = [
  ...
  { to: "/vendor/products/new", label: "Add Product", icon: PackagePlus },
  { to: "/vendor/orders", label: "Orders", icon: ShoppingBag },
  { to: "/vendor/earnings", label: "Earnings", icon: Wallet },
  { to: "/vendor/commissions", label: "Commissions", icon: BadgePercent },
  { to: "/vendor/partners", label: "Partners", icon: Users },
...
export const partnerNav: NavItem[] = [
  ...
  { to: "/partner/add-product", label: "Add Product", icon: PackagePlus },
  { to: "/partner/products", label: "Products", icon: Package },
  { to: "/partner/stock", label: "Stock Update", icon: Boxes },
...
export const adminNav: NavItem[] = [
  ...
  { to: "/admin/users", label: "Partners / Users", icon: Users },
